      ...
      <div className="container flex h-16 items-center px-4 mx-auto">
        ...
        <Link to="/" className="flex items-center gap-2 mr-6 group">
          ...
          <div className="flex flex-col">
            <span className="hidden md:inline-block font-bold text-lg transition-colors group-hover:text-green-600 dark:group-hover:text-green-400">Food Explorer</span>
            <span className="hidden md:inline-block text-xs text-muted-foreground">Discover Nutrition</span>
          </div>
        </Link>
        ...
        <div className="ml-auto flex items-center space-x-2">
          ...
          >
            {isMobileMenuOpen ? (
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-green-700 dark:text-green-400" viewBox="0 0 20 20" fill="currentColor">
      ...
      >
        <nav className="flex flex-col py-4 px-6">
          {navItems.map((item) => (
            ...
            >
              <span className="text-green-600 dark:text-green-500">{item.icon}</span>
              {item.label}
            </Link>
          ))}
        </nav>
